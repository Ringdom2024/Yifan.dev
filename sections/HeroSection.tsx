    ...
    >
        ...
        <div className="relative w-72 md:w-80 h-80 flex items-center mx-auto">
          <div className="absolute pointer-events-none scale-90 xs:scale-95 mx-auto">
            <Image
              ...
              aria-label={t("hero.characterAlt")}
              alt={t("hero.characterAlt")}
            />
          </div>
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="mt-2 my-4 md:mb-8">
          <p className="mb-1">{t("hero.intro1")}</p>
          <p>{t("hero.intro2")}</p>
        </div>
        <LinkButton href={contactHref}>{t("hero.contact")}</LinkButton>
      </div>
      ...
      <button
        ...
        className="group absolute link-outline animate-bounce hidden md:bottom-14 lg:bottom-16 left-1/2 -translate-x-1/2 md:flex items-center flex-col"
      >
